...
- **Plan Snapshot** — After a run, open **Plan Snapshot** for a one-page report of your plan: what to expect and a range of yearly withdrawals. Use **Export PDF** to save or print it from your browser.
